 ...
 *
 * Bypasses the entire ExoPlayer audio pipeline for FLAC files. A single native C++ thread handles:
 * FLAC decode → bit-depth conversion → USB isochronous transfers. Zero JNI in the hot path.
 *
 * Usage:
 * ```kotlin
 ...
 */
class NativeAudioEngine : NativeEngine {
     ...
     *
     * @param fd File descriptor for the FLAC file (will be dup'd internally).
    ...
    /**
     * Seek to a position in the FLAC stream. Uses the FLAC seek table for sample-accurate seeking.
     *
